...
console.log(color(figlet.textSync('AzzBot-MD', {
		font: 'Pagga',
...
console.log(color('\n🐶 YT CHANNEL: FDLMODZ ','silver'))
console.log(color('🐶 GITHUB: FADHLURAHMAN122 ','red'))
console.log(color('🐶 WA NUMBER: +6289604092736 ','green'))
console.log(color('  🦄FDLMODZ Inc. 2022🦄','mediumseagreen'))
